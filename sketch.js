...
function draw() {
   ...
   if (gameState === settingGame) {
      ...
      text(" your bullet increase in every 10 to 15 sec and 150 sec to complete", 10, 100)
      text("also same time there is some enemy stop near you this is also a part of game", 10, 130)
      fill("orange")
      textSize(30)
